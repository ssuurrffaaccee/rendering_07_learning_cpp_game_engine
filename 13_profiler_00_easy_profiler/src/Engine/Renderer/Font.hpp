...
class Font {
 public:
  ...
  struct Character {
    ...
    Character(float left_top_x, float left_top_y, float right_bottom_x,
 ...
 public:
  ...
  /// \return
  static Font* LoadFromFile(std::string font_file_path,
 ...
 private:
  static std::unordered_map<std::string, Font*>
      font_map_;  // 存储加载的字体 key：ttf路径 value：Font实例
};