...
void MeshRenderer::Render() {
  ...
  glUseProgram(gl_program_id);
  {
    ...
    game_object()->ForeachComponent(
        [](Component* component) { component->OnPreRender(); });
    ...
    glBindVertexArray(vertex_array_object_);
    {
      glDrawElements(GL_TRIANGLES, mesh_filter->mesh()->vertex_index_num_,
                     GL_UNSIGNED_SHORT,
    ...
    // PostRender
    game_object()->ForeachComponent(
        [](Component* component) { component->OnPostRender(); });
  }
}