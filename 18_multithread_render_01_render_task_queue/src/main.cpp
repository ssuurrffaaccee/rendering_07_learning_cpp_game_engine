...
#include "RenderTaskConsumer.hpp"
...
int main(void) {
  ...
  // 编译Shader任务
  RenderTaskProducer::ProduceRenderTaskCompileShader(
      vertex_shader_text, fragment_shader_text, program_id_);
  // 创建缓冲区任务
  RenderTaskProducer::ProduceRenderTaskCreateVAO(program_id_, kPositions,
                                                 sizeof(glm::vec3), kColors,
