...
class AudioCore {
 public:
  ...
  /// \param sound
  /// \return
  static FMOD_RESULT CreateSound(const char *name_or_data, FMOD_MODE mode,
  ...
  /// \param channel
  /// \return
  static FMOD_RESULT PlaySound(FMOD_SOUND *sound,
  ...
  /// \param up
  /// \return
  static FMOD_RESULT Set3DListenerAttributes(int listener,
