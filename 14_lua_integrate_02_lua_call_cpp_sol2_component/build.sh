...
$CONAN_EXE install ./mac_conanfile.txt --build=missing  --settings:all=compiler.cppstd=17 --settings:all=build_type=${BUILD_TYPE} --options=rttr/0.9.6:shared=True --options=rttr/0.9.6:with_rtti=True
