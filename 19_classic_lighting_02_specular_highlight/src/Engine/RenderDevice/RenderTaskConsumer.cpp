...
void RenderTaskConsumer::UpdateVBOSubData(RenderTaskBase *task_base) {
    ...
    //更新Buffer数据
    {
        // TimeRecorderWithCallback sub_data_time{[](float ms_time){
        //    DEBUG_LOG_INFO("glBufferSubData cost {}",ms_time);
        // }};
...
void RenderTaskConsumer::ProcessTask() {
    ...
    while (!glfwWindowShouldClose(window_))
    {
        ...
        while(true){
            ...
            // std::cout<<(size_t)render_task<<"\n";
            // std::cout<<RenderTaskQueue::Size()<<"command"<<"@"<<int(render_command)<<"\n";
            // std::cout<<render_task->GetName()<<"\n";
