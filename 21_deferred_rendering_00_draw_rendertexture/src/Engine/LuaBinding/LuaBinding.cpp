...
#include "Engine/Renderer/AnimationClip.hpp"
#include "Engine/Renderer/Animation.hpp"
#include "Engine/Renderer/SkinnedMeshRender.hpp"
...
void LuaBinding::BindLua() {
    ...
    //绑定glm::vec2
    {
        ...
        glm_ns_table.new_usertype<glm::vec2>("vec2",sol::call_constructor,sol::constructors<glm::vec2(const float&, const float&)>(),
                                             "x", &glm::vec2::x,
                                             "y", &glm::vec2::y,
                                             sol::meta_function::to_string,[] (const glm::vec2* vec) -> std::string {return to_string(*vec);},
                                             ...
                                             sol::meta_function::unary_minus,[] (const glm::vec2* vec) {return (*vec)*-1.0f;},
    ...
    //绑定glm::vec3
    {
        ...
        glm_ns_table.new_usertype<glm::vec3>("vec3",sol::call_constructor,sol::constructors<glm::vec3(const float&, const float&, const float&)>(),
                                             ...
                                             "g", &glm::vec3::g,
                                             "b", &glm::vec3::b,
                                             sol::meta_function::to_string,[] (const glm::vec3* vec) -> std::string {return to_string(*vec);},
                                             ...
                                             sol::meta_function::unary_minus,[] (const glm::vec3* vec) {return (*vec)*-1.0f;},
    ...
    //绑定glm::vec4
    {
        ...
        glm_ns_table.new_usertype<glm::vec4>("vec4",sol::call_constructor,sol::constructors<glm::vec4(const float&, const float&, const float&, const float&)>(),
                                             ...
                                             "b", &glm::vec4::b,
                                             "a", &glm::vec4::a,
                                             sol::meta_function::to_string,[] (const glm::vec4* vec) {return to_string(*vec);},
                                             ...
                                             sol::meta_function::unary_minus,[] (const glm::vec4* vec) {return (*vec)*-1.0f;},
    ...
    //绑定glm::mat4
    {
        ...
        glm_ns_table.new_usertype<glm::mat4>("mat4",sol::call_constructor,sol::constructors<glm::mat4(const float&)>(),
                                             sol::meta_function::to_string,[] (const glm::mat4* m) {return to_string(*m);},
                                             ...
                                             sol::meta_function::unary_minus,[] (const glm::mat4* m) {return (*m)*-1.0f;},
